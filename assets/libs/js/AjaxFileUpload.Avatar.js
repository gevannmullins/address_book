	...
	function fileUpload(event){  
		...
		for (var i = 0; i < files.length; i++) {
	 	...
	 	if(!error){
		 	...
		 	xhr.open('POST', '../admin/upload.users.avatar.php', true);
		 	xhr.send(data);
		 	xhr.onload = function () {
				//console.log(xhr);
