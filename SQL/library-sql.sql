...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `user_fullname` varchar(255) COLLATE utf8_persian_ci NOT NULL,
  `user_surname` varchar(255) COLLATE utf8_persian_ci NOT NULL,
  `user_email` varchar(255) COLLATE utf8_persian_ci NOT NULL,
  `user_login_name` varchar(255) COLLATE utf8_persian_ci NOT NULL,
  `user_login_pass` varchar(255) COLLATE utf8_persian_ci NOT NULL,
...
INSERT INTO `users` (`id`, `fullname`, `date`) VALUES
(1, 'admin', 'admin', 'gevann.mullins@gmail.com', 'admin', 'admin', '1980-01-15', '1980-01-15');
